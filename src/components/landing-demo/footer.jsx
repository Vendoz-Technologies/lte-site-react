        ...
        <div className="pv-cta-area bg-image">
            <div className="container">
                <div className="cta-content">
                    ...
                    <h2 className="title" data-sal-delay="100" data-sal="slide-up" data-sal-duration="1000">Create Your Education Website <br /> Today with LTE</h2>
                    <div className="button-group" data-sal-delay="400" data-sal="slide-up" data-sal-duration="1000">
                        <a href="https://1.envato.market/AoJezj" target="_blank" className="edu-btn">Download LTE <i className="icon-4"></i></a>
