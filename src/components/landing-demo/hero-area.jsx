                ...
                <div className="row justify-content-center">
                    <div className="col-lg-10">
                        <div className="banner-content">
                            <span className="subtitle" data-sal="slide-up" data-sal-duration="1000">Online Course & Education</span>
                            <h1 className="title" data-sal-delay="100" data-sal="slide-up" data-sal-duration="1000">Learn, Train & Earn Academy</h1>
                            <div className="banner-btn" data-sal-delay="400" data-sal="slide-up" data-sal-duration="1000">
                                <a href="https://1.envato.market/AoJezj" target="_blank" className="edu-btn">Download LTE Now <i className="icon-4"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
