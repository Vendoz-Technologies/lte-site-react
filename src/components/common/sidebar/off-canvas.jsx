                ...
                <div className="header-top">
                    <div className="logo">
                        <Link href="/">
                            ...
                            <img className="logo-light" src='/assets/images/logo/logo-white.png' alt="logo" style={{height: '120px'}} />
                            <img className="logo-dark" src='/assets/images/logo/logo-dark.png' alt="logo" style={{height: '120px', filter: 'invert(1)'}} />
